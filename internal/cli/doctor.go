...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  ubereats-pp-cli doctor
  ubereats-pp-cli doctor --json
  ubereats-pp-cli doctor --fail-on warn
  ubereats-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if credentialRefused {
				...
				if !credentialConfigured {
					...
					report["auth_hint"] = "ubereats-pp-cli auth login --chrome"
				} else {
					authConfigured = true
					...
					if cfg != nil && cfg.CredentialConfigured() {
						...
						report["auth_domain"] = ".ubereats.com"
			...
			if os.Getenv("UBEREATS_COOKIES") != "" {
				authEnvSet = append(authEnvSet, "UBEREATS_COOKIES")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "UBEREATS_COOKIES")
			}
			switch {
...
func collectCredentialsLocationReport(report map[string]any, cfg *config.Config) {
	...
	credentialRemediation := "run auth login or auth logout"
