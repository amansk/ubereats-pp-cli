...
but do not stop the import.`,
  ...
  ubereats-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ubereats-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ubereats-pp-cli import <resource> --input -`,
