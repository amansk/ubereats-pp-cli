...
import (
	...
	"ubereats-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ubereats-pp-cli auth login",
		"ubereats-pp-cli doctor",
		"ubereats-pp-cli help items",
		"ubereats-pp-cli sync",
		"ubereats-pp-cli profile list",
		"ubereats-pp-cli feedback list",
		"ubereats-pp-cli which",
		"ubereats-pp-cli agent-context",
		"ubereats-pp-cli completion bash",
		"ubereats-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ubereats-pp-cli recall",
		"ubereats-pp-cli learnings",
		"ubereats-pp-cli teach-pattern",
		"ubereats-pp-cli teach-lookup",
		"ubereats-pp-cli items list",
	}
