...
func (s *Store) migrateExtras(ctx context.Context, conn *sql.Conn) error {
	// Order-history mirror tables for the novel commands (sync, history,
	// spend, top-items, top-restaurants, find). The DDL lives next to the
	// queries in internal/orders so the schema and its readers evolve together.
